...
## How to contribute
Even if you just have an idea or want to give feedback, you can use the [SC2 Neuro WoL Integration Planner]()!

### Working on the integration
If you want to work on the integration then tell me your Github account name in the [Neuro-sama Discord]() under projects/SC2 WoL Integration or DM me and I will add you to the repo.
...
3. Download or clone this repo into your StarCraft 2 installation:
```
...\StarCraft II\<Here copy the SC2 Neuro WoL Integration repo>
```
...
### Guidelines
Any changes made to the game need to be documented in the [SC2 Neuro WoL Integration Planner]() so everyone knows what the current state of the integration is and what has changed.
